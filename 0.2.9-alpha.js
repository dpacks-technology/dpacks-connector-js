...
function admin() {
    ...
    div2.setAttribute("style", "border: 2px solid #737DFF; position: fixed; z-index: 2147483647; padding: 10px 10px; border-radius: 10px; width: 140px; right: 10px; margin: 0px; top: 10px!important; background-color: #000A2A;");
    div3.setAttribute("style", "border: 2px solid #737DFF; position: fixed; z-index: 2147483647; padding: 10px 10px; border-radius: 10px; width: 140px; right: 10px; margin: 0px; top: 46px!important; background-color: #000A2A;");
